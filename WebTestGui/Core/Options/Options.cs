...
namespace WebTestGui
{
    public partial class Options : UserControl
    {
        ...
        public void SetMainTextBoxText(string text)
        {
        ...
        public void SetMainComboboxSelected(string selectedItem)
        {
            mainComboBox.SelectedIndex = mainComboBox.FindStringExact(selectedItem);
        }
        ...
        public void SetMainCheckboxValue(bool value)
        {
            mainTextBox.Visible = false;
            mainComboBox.Visible = false;
            mainCheckbox.Checked = value;
        }
        ...
        public void SetSubTextboxText(string text)
        {
            subTextBox.Text = text;
        }
