...
{
    partial class SwitchBackAction
    {
        /// <summary> 
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SwitchBackAction));
            mainLabel = new Label();
            mainPanel = new Panel();
            ...
            testRunTimeText.Location = new Point(271, 39);
            ...
            testRunTimeLabel.Location = new Point(114, 39);
            ...
            label1.TabIndex = 36;
            label1.Text = "Visszavált iframe-ről.";
            // 
            // idLabel
            // 
