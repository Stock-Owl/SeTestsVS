...
{
    public partial class LoadedWaitForCondition : UserControl, IWaitForCondition
    {
        public LoadedWaitForCondition()
        {
            InitializeComponent();
        }

        public string m_WaitForConditionType { get { return "loaded"; } }
