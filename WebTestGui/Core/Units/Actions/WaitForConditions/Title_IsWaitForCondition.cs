...
{
    public partial class Title_IsWaitForCondition : UserControl, IWaitForCondition
    {
        public Title_IsWaitForCondition()
        {
            InitializeComponent();
        }

        public string m_WaitForConditionType { get { return "title_is"; } }
