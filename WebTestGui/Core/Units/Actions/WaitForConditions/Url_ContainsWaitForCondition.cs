...
{
    public partial class Url_ContainsWaitForCondition : UserControl, IWaitForCondition
    {
        public Url_ContainsWaitForCondition()
        {
            InitializeComponent();
        }

        public string m_WaitForConditionType { get { return "url_contains"; } }
